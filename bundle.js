...
/***/ function(module, exports) {
	...
	// curl --include --request DELETE  http://localhost:4741/fundraisers/3 \
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetAll = function onGetAll(event) {
	  event.preventDefault();
	  api.getAll().then(ui.getAllSuccess).catch(ui.failure);
	};

	var onGetLibraries = function onGetLibraries() {
	  if (store.user) {
	...
	var onCreateLib = function onCreateLib(event) {
	  ...
	  api.createLib(data).then(ui.createLibSuccess).then(function () {
	    onGetLibraries();
	...
	var onUpdateLib = function onUpdateLib(event) {
	  ...
	  api.updateLib(data).then(ui.updateLibSuccess).then(function () {
	    onGetLibraries();
	...
	var onDeleteLib = function onDeleteLib(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteLib(data).then(ui.deleteLibSuccess).then(function () {
	    onGetLibraries();
	  }).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllLibraries = __webpack_require__(33);
