...
/***/ function(module, exports, __webpack_require__) {
	...
	var crudEvents = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetLibraries = function onGetLibraries(event) {
	  event.preventDefault();
	  if (store.user) {
	    api.getLibraries().then(ui.getLibrariesSuccess).catch(ui.failure);
	  }
	};

	var onCreateLib = function onCreateLib(event) {
	  event.preventDefault();
	...
	module.exports = {
	  onGetAll: onGetAll,
	  onGetLibraries: onGetLibraries,
	  getAllHandler: getAllHandler,
	  onCreateLib: onCreateLib,
	  onUpdateLib: onUpdateLib,
	  onDeleteLib: onDeleteLib
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLibraries = function getLibraries(data) {
	  return $.ajax({
	...
	var createLib = function createLib(data) {
	  return $.ajax({
	    url: config.host + '/libraries',
	    method: 'POST',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllFundraisers = __webpack_require__(13);
	var createLibrary = __webpack_require__(33);
	var getAllLibraries = __webpack_require__(34);
	...
	var getLibrariesSuccess = function getLibrariesSuccess(data) {
	  $('.get-all-libraries').html(getAllLibraries(data));
	  console.log(data);
	};

	var createLibSuccess = function createLibSuccess(data) {
	  //  $('.show-library').html('My Library');
	  console.log(data);
	  $('.show-library').html(createLibrary(data));
	};

	var updateLibSuccess = function updateLibSuccess(data) {
	  console.log('working!');
	  console.log(data);
	};

	var deleteLibSuccess = function deleteLibSuccess() {
	  console.log('working!');
	  $('.show-library').hide();
	};
	...
	module.exports = {
	  ...
	  getLibrariesSuccess: getLibrariesSuccess,
	  createLibSuccess: createLibSuccess,
	  updateLibSuccess: updateLibSuccess,
	  deleteLibSuccess: deleteLibSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<li>\n  <h4>"
	    ...
	    + "</h5>\n\n  <!--<li <button type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#addtoLib\" id=\"add-to-lib\">Add to Library</li>\n    <li button type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#deleteFromLib\" id=\"deleteFromlib\">Delete from Library</li>\n-->\n</li>\n\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h3>ALL FUNDRAISERS</h3>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.fundraisers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<li>\n  <h3>Your New Library</h3>\n  <h4>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.library : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h4>\n  <h4>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.library : depth0)) != null ? stack1.id : stack1), depth0))
	    + "</h4>\n<ul>\n    <li button type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#deleteFromLib\" id=\"deleteFromlib\">Delete Library</li>\n</ul>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<h3>YOUR LIBRARIES</h3>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.libraries : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  <!--<li <button type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#addtoLib\" id=\"add-to-lib\">Add to Library</li>\n    <li button type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#deleteFromLib\" id=\"deleteFromlib\">Delete from Library</li>\n\n</li>\n-->\n";
	},"useData":true,"useBlockParams":true});
